...
this.sendButton(id, text, groupMetadata.subject, apii.data, [[(action == 'add' ? '💫 ДОБРО ПОЖАЛАВАТЬ 💫' : '#byegc'), (action == 'add' ? '#welcomegc' : 'ДОСВИДОС')], ['МЕНЮ', `#меню`]], ftroli, {mentions: this.parseMention(text)})
