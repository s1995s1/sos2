...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        premium: '*[ ⚠️ ПРЕДУПРИЖДЕНИЕ ⚠️ ] ЭТУ КОМАНДУ МОЖНО ИСПОЛЬЗОВАТЬ ТОЛЬКО ПРЕМИУМ ПОЛЬЗОВАТЕЛИ И ВЛАДЕЛЕЦ БОТА*',
        group: '*[ ⚠️ ПРЕДУПРИЖДЕНИЕ ⚠️ ] ЭТУ КОМАНДУ МОЖНО ИСПОЛЬЗОВАТЬ ТОЛЬКО В ГРУППЕ*',
        private: '*[ ⚠️ ПРЕДУПРИЖДЕНИЕ ⚠️ ] ЭТУ КОМАНДУ МОЖНО ИСПОЛЬЗОВАТЬ ТОЛЬКО В ПРИВАТНОМ ЧАТЕ БОТА*',
        admin: '*[ ⚠️ ПРЕДУПРИЖДЕНИЕ ⚠️ ] ЭТУ КОМАНДУ МОЖНО ИСПОЛЬЗОВАТЬ ТОЛЬКО АДМИНОМ ГРУППЫ*',
        botAdmin: '*[ ⚠️ ПРЕДУПРИЖДЕНИЕ ⚠️ ] ЧТОБЫ ИМЕТЬ ВОЗМОЖНОСТЬ ИСПОЛЬЗОВАТЬ ЭТУ КОМАНДУ БОТ ДОЛЖЕН БЫТЬ АДМИНОМ ЭТОЙ ГРУППЫ*',
        unreg: '*[ 🛑 ЭЙ!! ВЫСОКИЙ, ТЫ НЕ ЗАРЕГИСТРИРОВАН 🛑 ]*\n\n*—◉ РЕГИСТИРУЙСЯ ПО КОМАНДЕ*\n*➣ #регистрацыя*',
        restrict: '*[ ⚠️ ПРЕДУПРИЖДЕНИЕ ⚠️ ] АТА КОМАНДА РЕГИСТРИРУЕТСЯ.ОТКЛЮЧАЕТСЯ ПО РЕШЕНИЮ ВЛАДЕЛЬЦА*'
    }[type]
