...
this.sendButton(id, text, groupMetadata.subject, apii.data, [[(action == 'add' ? '💫 ДОБРО ПОЖАЛАВАТЬ 💫' : 'ДОСВИДОС'), (action == 'add' ? '#welcomegc' : 'ДОСВИДОС')], ['МЕНЮ', `#меню`]], ftroli, {mentions: this.parseMention(text)})
