...
*—◉ 𝙴𝙻 𝙽𝚄𝙼𝙴𝚁𝙾 𝙳𝙴𝙻 𝙲𝙾𝙻𝙰𝙱𝙾𝚁𝙰𝙳𝙾𝚁 𝟷 𝙴𝚂 wa.me/+79010070455*

*—◉ 𝙴𝙻 𝙲𝙾𝙽𝚃𝙰𝙲𝚃𝙾 𝙳𝙴 𝙻𝙰 𝙲𝙾𝙻𝙰𝙱𝙾𝚁𝙰𝙳𝙾𝚁𝙰 9 𝙴𝚂 https://instagram.com*
`.trim()   
let buttonMessage= {
...
{buttonId: `${usedPrefix}меню2`, buttonText: {displayText: 'МЕНЮ2'}, type: 1}],
'headerType': 6 }
...
handler.tags = ['info']
handler.command = /^(владелиц|creator|creador|propietario)$/i
